export class EditPaymentDTO {
  constructor({ id, amount, paymentDate, method, status, invoiceId }) {
    if (!amount || !paymentDate || !method || !status || !invoiceId) {
      throw new Error("Faltan datos requeridos para editar el pago.");
    }
