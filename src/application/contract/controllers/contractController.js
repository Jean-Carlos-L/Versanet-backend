...
import { registerContract, getAllContracts, getContractById, editContract, deleteContract } from '../usecases/index.js';
...
router.get('/', async (req, res) => {
    try {
        ...
        const filters = {
            ...
            customer_name: req.query.customer_name || req.query.name || req.query.nombres || null,
            customer_document: req.query.customer_document || req.query.cedula || req.query.document || null,
            date_from: req.query.date_from || req.query.fecha_desde || null,
            date_to: req.query.date_to || req.query.fecha_hasta || null,
            estado: req.query.estado || null,
        };

        const { contracts, total } = await getAllContracts({ page, pageSize, offset, limit, filters });
...
router.put('/:id', async (req, res) => {
    try {
        console.log('ContractController.put - body:', req.body);
